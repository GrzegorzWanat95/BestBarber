...
<div class="overall_rating">
    ...
    <span class="total"><?=$reviews_info['total_reviews']?> opinii</span>
</div>
<a href="#" class="write_review_btn">Napisz opinię</a>
<div class="write_review">
    <form>
        <input name="name" type="text" placeholder="Twój nick" required>
        <input name="rating" type="number" min="1" max="5" placeholder="Oceń (1-5)" required>
        <textarea name="content" placeholder="Wpisz swoją opinie.." required></textarea><br>
